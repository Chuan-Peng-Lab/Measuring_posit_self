var jsPsychSurveyLikert = (function (jspsych) {
  ...
  class SurveyLikertPlugin {
      ...
      trial(display_element, trial) {
          ...
          html +=
          ".jspsych-content-wrapper { display: flex;margin: auto;flex: 1 1 100%; width: 100%; overflow: auto;} "+
              ".jspsych-survey-likert-statement { display:block; font-size: 22px; padding-top: 5px; margin-bottom:27px; }" +
                  ".jspsych-survey-likert-opts { list-style:none; width:" +
                  w +
                  "; margin:auto; padding:0 0 px; display:block; font-size: 16px; line-height:0.2em; }" +
                  ".jspsych-survey-likert-opt-label { line-height: 1.8em; color: #444; }" +
                  ".jspsych-survey-likert-opts:before { content: ''; position:relative; top:-2px; /*left:9.5%;*/ display:block; background-color:#efefef; height:2px; width:100%; margin:-11px; }" +
                  ".jspsych-survey-likert-opts:last-of-type { border-bottom: 0; }" +
                  ".jspsych-survey-likert-opts li { display:inline-block; /*width:25%;*/ text-align:center; vertical-align: top; }" +
