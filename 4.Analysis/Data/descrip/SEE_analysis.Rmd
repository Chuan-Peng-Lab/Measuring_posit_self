...
```{r}
raw_day1<-read.csv("../../Data/raw/day1/phase_003/day1_phase_003.csv")#修改phase_002
...
IAT_order <- function(data,IAT_analysis) {
  ...
  mutate(IAT_first = ifelse(trial_idx_IAT_moral < trial_idx_IAT_ability, "moral_first", "ability_first"))%>%
    subset(., ID %in% subj_phase_003)
  print(merged_data)
}

IAT_order(raw_day1,IAT_phase_003_analysis)
```
...
IAT_rt_plot(IAT_phase_003_analysis)
```
...
IAT_D_plot(IAT_phase_003_analysis)
```
