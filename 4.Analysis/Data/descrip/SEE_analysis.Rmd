...
file_list <- list.files(path = folder_path, pattern = "\\phase_004.csv$", full.names = TRUE, recursive = TRUE)
...
# 循环读取每个子文件夹下的 phase_0xx 文件夹内的 CSV 文件
for (subfolder in subfolders) {
  phase_folder <- file.path(subfolder, "phase_004")
