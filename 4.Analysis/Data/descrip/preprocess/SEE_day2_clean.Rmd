...
# 调用函数并传入相应的 phase 参数
subj_phase_day2("phase_006","10","12.12")
...
list.files("../../../Data/raw/day2/phase_006/jsPsych",pattern = "\\.csv$", full.names = TRUE)#修改批次号
...
combine_csv_files("phase_006",1,23)
...
select(-c("subj_idx"))
 ...
 trap2<-day20%>%
 filter(grepl("我", trap2_item) | trial_index == 0)%>%
...
day2_process("phase_006")

  day20 <- read.csv("../../../Data/raw/day2/phase_006/day2_phase_006.csv", fileEncoding = "UTF-8")
