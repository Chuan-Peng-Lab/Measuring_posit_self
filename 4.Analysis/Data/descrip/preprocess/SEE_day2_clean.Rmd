...
# 调用函数并传入相应的 phase 参数
subj_phase_day2("phase_015","10","2.1")
...
list.files("../../../Data/raw/day2/phase_013/jsPsych",pattern = "\\.csv$", full.names = TRUE)#修改批次号
...
combine_csv_files("phase_015",1,38)
...
day2_process("phase_015")
 subj_day0 <- read.xlsx(paste0("../../../Data/raw/day2/","phase_015", "/subj_day2_","phase_015", ".xlsx"))
```
