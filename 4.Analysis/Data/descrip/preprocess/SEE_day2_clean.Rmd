...
# 调用函数并传入相应的 phase 参数
subj_phase_day2("phase_004","10","11.19")
...
list.files("../../../Data/raw/day2/phase_004/jsPsych",pattern = "\\.csv$", full.names = TRUE)#修改批次号
...
combine_csv_files("phase_004",1,18)
