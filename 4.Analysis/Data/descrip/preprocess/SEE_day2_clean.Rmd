...
# 调用函数并传入相应的 phase 参数
subj_phase_day2("phase_005","10","11.26")
...
list.files("../../../Data/raw/day2/phase_005/jsPsych",pattern = "\\.csv$", full.names = TRUE)#修改批次号
...
combine_csv_files("phase_005",1,18)
