...
# 调用函数并传入相应的 phase 参数
subj_phase_day2("phase_003","10","11.4")
...
list.files("../../../Data/raw/day2/phase_003/jsPsych",pattern = "\\.csv$", full.names = TRUE)#修改批次号
...
combine_csv_files("phase_003",1,12)
...
get_first_trial_indices("phase_003")
```
