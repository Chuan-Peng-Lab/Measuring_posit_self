...
subj_phase_day1("phase_008","10","12.24")
...
list.files("../../../Data/raw/day1/phase_008/jsPsych",pattern = "\\.csv$", full.names = TRUE)#修改phase_003为当前批次号，即可查看本次day1收集到的数据文件
...
combine_csv_files("phase_008", 1,19)
