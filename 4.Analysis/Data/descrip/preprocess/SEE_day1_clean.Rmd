...
subj_phase_day1("phase_007","10","12.19")
...
list.files("../../../Data/raw/day1/phase_007/jsPsych",pattern = "\\.csv$", full.names = TRUE)#修改phase_003为当前批次号，即可查看本次day1收集到的数据文件
...
combine_csv_files("phase_007", 1,17)
...
assign("trap1", trap1, envir = .GlobalEnv)
}

## 运行范例，[标记不同批次]


day1_process("phase_007")
```
