...
subj_phase_day1("phase_015","10","1.28")
...
list.files("../../../Data/raw/day1/phase_015/jsPsych",pattern = "\\.csv$", full.names = TRUE)  
...
combine_csv_files("phase_015", 1,46)
...
IAT <- day10 %>%
 ...
 mutate(ParticipantID = ifelse(ParticipantID == 322 & friend_name == "吴", 321, ParticipantID))%>%
   left_join(subj_day0 %>% select(ID,ParticipantID), by = "ParticipantID") %>%
