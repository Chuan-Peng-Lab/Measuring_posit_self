...
subj_day0_phase_003<-read.csv(list.files("../../../Data/raw/day0/phase_003/",pattern = "^SEE.*\\.csv$", full.names = TRUE), header = TRUE, sep = ",", stringsAsFactors = FALSE, fileEncoding = "UTF-8")%>%
    slice(-1)%>%
