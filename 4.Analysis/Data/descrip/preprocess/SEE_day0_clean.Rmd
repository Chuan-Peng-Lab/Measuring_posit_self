...
list.files("../../../Data/raw/day0/phase_008/jsPsych",pattern = "\\.csv$", full.names = TRUE)
...
combine_csv_files("phase_008",1,20)
```


### Prepare clean data for variables.

##先在../../../Data/clean/clean_day0/建立子文件phase_004
...
subj_phase_day0("phase_008","yes","1","12.20      ")
```
...
## gad 0、1、2、3分。ＧＡＤ－7总分范围为0～21分。分值 5、10、15分别对应代表“轻度”、“中度”、“重度”焦 虑程度分界值。国外大规模样本研究显示当分 界值取10分时，ＧＡＤ－7的敏感度和特异度最佳，分别为89％和82%
