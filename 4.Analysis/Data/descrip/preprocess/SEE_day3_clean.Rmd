...
```{r}
subj_day0_phase_002<-read.xlsx("../../../Data/raw/day0/phase_002/subj_day0_phase_002.xlsx")#修改phase_002
# 导入文件，修改phase_002
subj_day3_phase_002<-read.csv(list.files("../../../Data/raw/day3/phase_002/",pattern = "^SEE.*\\.csv$", full.names = TRUE), header = TRUE, sep = ",", stringsAsFactors = FALSE, fileEncoding = "UTF-8")%>%
    slice(-1)%>%
  ...
  mutate(Eligible="",
         Moneny="",
         Paid_date="")%>%
 merge(.,subj_day0_phase_002[, c("USERID", "ID","ParticipantID")], by = "USERID", all.x = TRUE) #修改phase_002 
# 导出文件
write.xlsx(subj_day3_phase_002, "../../../Data/raw/day3/phase_002/subj_day3_phase_002.xlsx")#修改phase_002
```

### 检查工作环境，查看文件列表,合并本批day2所有被试的数据
```{r check environment}
#check out all '.csv' files in a folder, ‘..’ 表示返回上一级目录，因此 ../../.. 表示在当前工作目录的上两级目录下找到 "4.Analysis" 目录
list.files("../../../Data/raw/day3/phase_002/jsPsych",pattern = "\\.csv$", full.names = TRUE)
...
# 使用示例，每次运行仅需修改此3个参数
combine_csv_files("phase_002",1,13)#修改phase_002
...
day3_process<-function(phase){
  filePath<-paste0("../../../Data/raw/day3/",phase,"/day3_phase_002",".csv")
...
day3_q <- day3 %>%
  ...
  merge(.,subj_day0_phase_002[, c("ID","ParticipantID")], by = "ParticipantID", all.x = TRUE)#修改phase_002
...
day3_process("phase_002")#修改phase_002

```


```{r}
day3_q <-read.csv("../../../Data/clean/clean_day3/phase_002/day3_q_phase_002.csv")#修改phase_002
day3_q  <- day3_q  %>%
...
```{r}
day2_q <-read.csv("../../../Data/clean/clean_day2/phase_002/day2_q_phase_002.csv")#修改phase_002
day0_q <-read.csv("../../../Data/clean/clean_day0/phase_002/day0_all_phase_002.csv")#修改phase_002
day1_q<-read.csv("../../../Data/clean/clean_day1/phase_002/day1_q_phase_002.csv")#修改phase_002
