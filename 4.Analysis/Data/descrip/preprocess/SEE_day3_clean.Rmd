...
# 使用示例，每次运行仅需修改此3个参数
combine_csv_files("phase_004",1,18)#修改phase_002
...
day3_process("phase_004")#修改phase_002

```


```{r}
day3_q <-read.csv("../../../Data/clean/clean_day3/phase_004/day3_q_phase_004.csv")#修改phase_002
day3_q  <- day3_q  %>%
...
subj_phase_004 <- unique(day3_q$ID)
...
```{r}
day2_q <-read.csv("../../../Data/clean/clean_day2/phase_004/day2_q_phase_004.csv")#修改phase_002
day0_q <-read.csv("../../../Data/clean/clean_day0/phase_004/day0_all_phase_004.csv")#修改phase_002
day1_q<-read.csv("../../../Data/clean/clean_day1/phase_004/day1_q_phase_004.csv")#修改phase_002
...
day0t2_q<- subset(day0t2_q, ID %in% subj_phase_004)%>%
  mutate(
    phq_al = rowSums(select(., starts_with("phq")), na.rm = TRUE),
    gad_al = rowSums(select(., starts_with("gad")), na.rm = TRUE),
    selfclarity_al = rowSums(select(., starts_with("selfclarity")), na.rm = TRUE),
