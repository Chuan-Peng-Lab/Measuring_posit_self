...
# 使用示例，每次运行仅需修改此3个参数
combine_csv_files("phase_007",1,15)#修改phase_002
...
day3_process("phase_007")#修改phase_002

```


```{r}
day3_q <-read.csv("../../../Data/clean/clean_day3/phase_006/day3_q_phase_006.csv")#修改phase_002
day3_q_1  <- day3_q  %>%
...
subj_phase_006 <- unique(day3_q$ID)
