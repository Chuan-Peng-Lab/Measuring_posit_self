...
# 导入文件，修改phase_002
subj_day3_phase_003<-read.csv(list.files("../../../Data/raw/day3/phase_003/",pattern = "^SEE.*\\.csv$", full.names = TRUE), header = TRUE, sep = ",", stringsAsFactors = FALSE, fileEncoding = "UTF-8")%>%
    slice(-1)%>%
...
# 导出文件
write.xlsx(subj_day3_phase_003, "../../../Data/raw/day3/phase_003/subj_day3_phase_003.xlsx")#修改phase_002
```
